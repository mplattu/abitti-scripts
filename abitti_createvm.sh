...
# Add more storage to KTP/KOE image
...
${VBM} modifyvm Abitti-KOE --memory 2048 --nic1 intnet --intnet1 abitti --usb on --usbehci on
${VBM} modifyvm Abitti-KTP --memory 4096 --nic1 intnet --intnet1 abitti --usb on --usbehci on
